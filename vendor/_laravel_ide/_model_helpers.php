...
namespace App\Models {
     ...
     * @property string $nutrition_fact
     * @property string $name
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $id
     * @property-read \App\Models\Category $category
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food whereNutritionFact($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food wherePrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food whereCategoryId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food having(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, \DateTimeInterface|string|int|float|null $operator, \Illuminate\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food orHaving(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, \DateTimeInterface|string|int|float|null $operator, \Illuminate\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null $value)
     ...
     * @method static list getBindings()
     * @method static array{select: list, from: list, join: list, where: list, groupBy: list, having: list, order: list, union: list, unionOrder: list} getRawBindings()
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food setBindings(list $bindings, string $type)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food addBinding(mixed $value, string $type)
     * @method static mixed castBinding(mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food mergeBindings(self $query)
     * @method static list cleanBindings(array $bindings)
     * @method static mixed flattenValue(mixed $value)
     * @method static string defaultKeyName()
     * @method static \Illuminate\Database\ConnectionInterface getConnection()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food wherePastOrFuture(array|string $columns, string $operator, string $boolean)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food orWhereTodayOrBefore(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food orWhereAfterToday(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<Food>|Food orWhereTodayOrAfter(array|string $columns)
